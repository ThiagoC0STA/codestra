...
export default function MainPortfolioSinglePage1Dark({ params }: any) {
  const portfolioItem =
    portfolios1.filter((elm) => elm.id == parseInt(params.id))[0] || portfolios1[0];
  return (
    <>
                              ...
                              <div key={index} className="mb-30 wow fadeInUp">
                                {(media as any).src
                                  ...
                                  <video
                                    ...
                                    preload="metadata"
                                    loop={(media as any)?.loopMuted ?? false}
                                    autoPlay={(media as any)?.loopMuted ?? false}
                                    muted={(media as any)?.loopMuted ? true : false}
                                    playsInline={
                                      (media as any)?.loopMuted ? true : false
                                    }
                                    ...
                                    controls={(media as any)?.loopMuted ? false : true}
                                    controlsList={
                                      (media as any)?.loopMuted
                                  ...
                                  <Image
                                    src={(media as any).src}
                                    alt={(media as any).alt || "Portfolio media"}
                                    width={1350}
                                    height={865}
