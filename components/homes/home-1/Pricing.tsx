...
export default function Pricing({ items = pricing }: any) {
  const [isYearly, setIsYearly] = useState(false);
  const hasPrice = items.some((item: any) => item.price !== null);
                    ...
                    <div className="pricing-wrap">
                      ...
                      <div className="pricing-features">
                        <ul className="pr-list">
                          {item.features?.map((elm: any, i: any) => (
                            <li key={i}>
                              <i className="mi-check" /> {elm}
                            </li>
                          ))}
                          {item.disabledFeatures?.map((elm: any, i: any) => (
