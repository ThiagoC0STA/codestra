            ...
            <>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Criatividade</div>
                  <div className="features-descr">
                    Desenvolvemos conteúdo criativo e estratégico para suas redes sociais, 
                    garantindo engajamento e resultados consistentes.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Compromisso</div>
                  <div className="features-descr">
                    Comprometidos com o crescimento do seu negócio através de estratégias 
                    personalizadas e acompanhamento constante dos resultados.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Fidelização</div>
                  <div className="features-descr">
                    Construímos relacionamentos duradouros com nossos clientes, 
                    focando em resultados consistentes e comunicação transparente.
                  </div>
                </div>
              </SwiperSlide>
              <SwiperSlide className="owl-item">
                <div className="features-item">
                  ...
                  <div className="features-title">Inovação</div>
                  <div className="features-descr">
                    Sempre atualizados com as últimas tendências em marketing digital
