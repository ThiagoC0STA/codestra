export const featureItems = [
  {
    ...
    description:
      "Criamos e gerenciamos conteúdo envolvente para suas redes sociais, aumentando seu alcance e engajamento.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    description:
      "Estratégias completas de marketing digital para aumentar sua presença online e converter seguidores em clientes.",
  },
  {
    id: 3,
    ...
    description:
      "Produzimos conteúdo relevante e criativo que conecta sua marca com seu público-alvo nas redes sociais.",
  },
];
...
export const featureItems2 = [
  {
    ...
    description:
      "Com anos de experiência no mercado digital, entregamos resultados consistentes e mensuráveis para nossos clientes.",
  },
  {
    id: 2,
    className: "col-lg-6",
    path: "M21.62 20.196c1.055-.922 1.737-2.262 1.737-3.772 0-1.321-.521-2.515-1.357-3.412v-6.946l-11.001-6.066-11 6v12.131l11 5.869 5.468-2.917c.578.231 1.205.367 1.865.367.903 0 1.739-.258 2.471-.676l2.394 3.226.803-.596-2.38-3.208zm-11.121 2.404l-9.5-5.069v-10.447l9.5 4.946v10.57zm1-.001v-10.567l5.067-2.608.029.015.021-.04 4.384-2.256v5.039c-.774-.488-1.686-.782-2.668-.782-2.773 0-5.024 2.252-5.024 5.024 0 1.686.838 3.171 2.113 4.083l-3.922 2.092zm6.833-2.149c-2.219 0-4.024-1.808-4.024-4.026s1.805-4.025 4.024-4.025c2.22 0 4.025 1.807 4.025 4.025 0 2.218-1.805 4.026-4.025 4.026z",
    title: "Equipe Especializada",
    description:
      "Nossa equipe multidisciplinar combina criatividade e expertise técnica para desenvolver estratégias personalizadas.",
  },
  {
    id: 3,
    className: "col-lg-6",
    ...
    description:
      "Utilizamos as mais recentes ferramentas e tecnologias do mercado para maximizar o desempenho das suas campanhas.",
  },
  {
    id: 4,
    className: "col-lg-6",
    path: "M6.514 24.015h-3v-3.39c-2.08-.638-3.5-2.652-3.5-5.04 0-1.19.202-1.693 1.774-5.603.521-1.294 1.195-2.97 2.068-5.179.204-.518.67-.806 1.17-.802.482.004.941.284 1.146.802.718 1.817 1.302 3.274 1.777 4.454.26-.596.567-1.288.928-2.103.694-1.565 1.591-3.592 2.754-6.265.258-.592.881-.906 1.397-.888.572.015 1.126.329 1.369.888z",
    title: "Atendimento Personalizado",
    description:
      "Cada cliente é único. Por isso, desenvolvemos estratégias sob medida para atender às necessidades específicas do seu negócio.",
  },
];
...
export const features2 = [
  {
    id: 1,
    text: "Pequenas e Médias Empresas",
  },
  {
    id: 2,
...
export const features5 = [
  {
    title: "Gestão de Redes Sociais",
    description:
      "Gerenciamento profissional das suas redes sociais, criação de conteúdo relevante e estratégias de engajamento para fortalecer sua marca.",
    svgPath:
  ...
  },
  {
    title: "Marketing Digital",
    description:
      "Estratégias completas de marketing digital, incluindo SEO, tráfego pago e email marketing para aumentar sua visibilidade online.",
    svgPath:
  ...
  },
  {
    title: "Criação de Conteúdo",
    description:
      "Produção de conteúdo original e envolvente, incluindo textos, imagens e vídeos para todas as suas plataformas digitais.",
    svgPath:
      "M6.514 24.015h-3v-3.39c-2.08-.638-3.5-2.652-3.5-5.04 0-1.19.202-1.693 1.774-5.603.521-1.294 1.195-2.97 2.068-5.179.204-.518.67-.806 1.17-.802.482.004.941.284 1.146.802.718 1.817 1.302 3.274 1.777 4.454.26-.596.567-1.288.928-2.103.694-1.565 1.591-3.592 2.754-6.265.258-.592.881-.906 1.397-.888.572.015 1.126.329 1.369.888 1.163 2.673 2.06 4.7 2.754 6.265 2.094 4.727 2.363 5.334 2.363 6.764 0 2.927-2.078 5.422-5 6.082v4.015h-3v-4.015c-.943-.213-1.797-.617-2.523-1.165-.612.845-1.466 1.48-2.477 1.79v3.39zm14.493-6c1.652 0 2.993 1.341 2.993 2.993s-1.341 2.993-2.993 2.993-2.993-1.341-2.993-2.993 1.341-2.993 2.993-2.993zm.007.993c1.104 0 2 .896 2 2s-.896 2-2 2-2-.896-2-2 .896-2 2-2zm-7.5 3.993v-3.839c4.906-.786 5-4.751 5-5.244 0-1.218-.216-1.705-2.277-6.359-2.134-4.82-2.721-6.198-2.755-6.261-.079-.145-.193-.292-.455-.297-.238 0-.37.092-.481.297-.034.063-.621 1.441-2.755 6.261-2.061 4.654-2.277 5.141-2.277 6.359 0 .493.094 4.458 5 5.244v3.839h1zm-6.123-12.448l-.08-.198c-1.589-3.957-2.04-5.116-2.067-5.171-.072-.151-.15-.226-.226-.228-.109 0-.188.13-.235.228-.028.05-.316.818-2.066 5.171-1.542 3.833-1.703 4.233-1.703 5.23 0 1.988 1.076 3.728 3.5 4.25v3.166h1v-3.166c1.266-.273 2.159-.876 2.725-1.666-1.078-1.12-1.725-2.619-1.725-4.251 0-.979.126-1.572.877-3.365z",
  },
  {
    ...
    description:
      "Análise personalizada do seu negócio e mercado, desenvolvendo estratégias eficientes para alcançar seus objetivos digitais.",
    svgPath:
