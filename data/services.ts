...
export const services6 = [
  {
    ...
    text: "Gerenciamento profissional das suas redes sociais, incluindo planejamento estratégico, criação de conteúdo, interação com seguidores e análise de métricas para maximizar resultados.",
  },
  {
    width: 60,
    height: 64,
    ...
    text: "Estratégias completas de marketing digital para aumentar sua presença online, gerar leads qualificados e converter mais vendas através de ações integradas e direcionadas.",
  },
  {
    width: 50,
    height: 64,
    ...
    text: "Produção de conteúdo relevante e estratégico para suas redes sociais, incluindo textos, imagens e vídeos que engajam seu público e fortalecem sua marca.",
  },
  {
    width: 48,
    height: 64,
    path: "M24.125 20c3.25 0 6.25 1.25 8.5 3.5s3.5 5.25 3.5 8.5-1.25 6.25-3.5 8.5-5.25 3.5-8.5 3.5-6.25-1.25-8.5-3.5-3.5-5.25-3.5-8.5 1.25-6.25 3.5-8.5 5.25-3.5 8.5-3.5zM24.125 42c5.5 0 10-4.5 10-10s-4.5-10-10-10-10 4.5-10 10 4.5 10 10 10zM17.25 10.375c-1.25 0.375-2.5 0.875-3.75 1.5 0.25 1 0.125 2 0 3-0.25 1.625-1 3.125-2.25 4.375-1.5 1.5-3.625 2.375-5.75 2.375-0.5 0-1.125 0-1.625-0.125-0.625 1.25-1.125 2.5-1.5 3.75 0.875 0.5 1.5 1.25 2.125 2.125 1 1.375 1.5 3 1.5 4.625s-0.5 3.25-1.5 4.625c-0.625 0.875-1.25 1.625-2.125 2.125 0.375 1.25 0.875 2.5 1.5 3.75 0.5-0.125 1.125-0.125 1.625-0.125 2.125 0 4.25 0.875 5.75 2.375 1.25 1.25 2 2.75 2.25 4.375 0.125 1 0.25 2 0 3 1.25 0.625 2.5 1.125 3.75 1.5 0.5-0.875 1.25-1.5 2.125-2.125 1.375-1 3-1.5 4.625-1.5s3.25 0.5 4.625 1.5c0.875 0.625 1.625 1.25 2.125 2.125 1.25-0.375 2.5-0.875 3.75-1.5-0.25-1-0.125-2 0-3 0.25-1.625 1-3.125 2.25-4.375 1.5-1.5 3.625-2.375 5.75-2.375 0.5 0 1.125 0 1.625 0.125 0.625-1.25 1.125-2.5 1.5-3.75-0.875-0.5-1.5-1.25-2.125-2.125-1-1.375-1.5-3-1.5-4.625s0.5-3.25 1.5-4.625c0.625-0.875 1.25-1.625 2.125-2.125-0.375-1.25-0.875-2.5-1.5-3.75-0.5 0.125-1.125 0.125-1.625 0.125-2.125 0-4.25-0.875-5.75-2.375-1.25-1.25-2-2.75-2.25-4.375-0.125-1-0.25-2 0-3-1.25-0.625-2.5-1.125-3.75-1.5-0.5 0.875-1.25 1.5-2.125 2.125-1.375 1-3 1.5-4.625 1.5s-3.25-0.5-4.625-1.5c-0.875-0.625-1.625-1.25-2.125-2.125z",
    title: "Tráfego Pago",
    text: "Gestão especializada de campanhas publicitárias nas principais plataformas digitais, otimizando seu investimento para alcançar os melhores resultados.",
  },
  {
    width: 48,
    height: 64,
    ...
    text: "Criação de identidade visual, materiais gráficos e peças publicitárias que comunicam a essência da sua marca e capturam a atenção do seu público-alvo.",
  },
  {
    width: 36,
    height: 64,
    ...
    text: "Análise aprofundada do seu negócio e mercado, desenvolvendo estratégias personalizadas para alcançar seus objetivos de marketing digital e crescimento online.",
  },
];
